                ...
                <div className="container py-3">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-6">
                            <h2 className={'h6 cred fw-semibold'} data-aos={'fade-left'} data-aos-delay={100}>
                            ...
                            <h3 className={'h1 cred fw-bold'} data-aos={'fade-left'} data-aos-delay={300}>Prabhjot Sir</h3>
                            <p className={'fs-5 mb-5 text-muted'} data-aos={'fade-left'} data-aos-delay={500}>
